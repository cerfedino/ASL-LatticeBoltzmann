...
def main():
    ...
    plt_all.savefig(f"{OUTPUT_FOLDER}/nodrift_roofline_plot.out.pdf", bbox_inches='tight', pad_inches=0)
    plt_rho.savefig(f"{OUTPUT_FOLDER}/nodrift_roofline_plot_rho.out.pdf", bbox_inches='tight', pad_inches=0)
    plt_feq.savefig(f"{OUTPUT_FOLDER}/nodrift_roofline_plot_feq.out.pdf", bbox_inches='tight', pad_inches=0)
    plt_f.savefig(f"{OUTPUT_FOLDER}/nodrift_roofline_plot_f.out.pdf", bbox_inches='tight', pad_inches=0)
    plt_vort.savefig(f"{OUTPUT_FOLDER}/nodrift_roofline_plot_vort.out.pdf", bbox_inches='tight', pad_inches=0)
    bar_fig.savefig(f"{OUTPUT_FOLDER}/nodrift_bar_plot.out.pdf", bbox_inches='tight', pad_inches=0)
